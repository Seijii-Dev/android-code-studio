...
package com.axiom.rv2ide.terminal
...
import com.axiom.rv2ide.app.configuration.CpuArch
  ...
  companion object {
    ...
    private fun writeIdesetupScript(context: Context, script: File): Boolean {
      return try {
        ...
        val folderName =
            when (cpuArch) {
              com.axiom.rv2ide.app.configuration.CpuArch.AARCH64 -> "arm64"
              com.axiom.rv2ide.app.configuration.CpuArch.ARM -> "arm"
              com.axiom.rv2ide.app.configuration.CpuArch.X86_64 -> "x86_64"
              com.axiom.rv2ide.app.configuration.CpuArch.X86 -> "x86"
            }
