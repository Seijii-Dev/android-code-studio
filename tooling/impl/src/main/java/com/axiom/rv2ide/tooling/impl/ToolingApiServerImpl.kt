...
package com.axiom.rv2ide.tooling.impl
...
import com.axiom.rv2ide.tooling.api.messages.GradleDistributionParams
import com.axiom.rv2ide.tooling.api.messages.GradleDistributionType
import com.axiom.rv2ide.tooling.api.messages.InitializeProjectParams
import com.axiom.rv2ide.tooling.api.messages.TaskExecutionMessage
import com.axiom.rv2ide.tooling.api.messages.result.BuildCancellationRequestResult
import com.axiom.rv2ide.tooling.api.messages.result.BuildCancellationRequestResult.Reason.CANCELLATION_ERROR
import com.axiom.rv2ide.tooling.api.messages.result.BuildInfo
import com.axiom.rv2ide.tooling.api.messages.result.BuildResult
import com.axiom.rv2ide.tooling.api.messages.result.InitializeResult
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_CANCELLED
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_FAILED
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_CLOSED
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_ERROR
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_DIRECTORY_INACCESSIBLE
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_DIRECTORY
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_FOUND
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_INITIALIZED
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNKNOWN
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_BUILD_ARGUMENT
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_CONFIGURATION
import com.axiom.rv2ide.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_GRADLE_VERSION
import com.axiom.rv2ide.tooling.api.models.ToolingServerMetadata
import com.axiom.rv2ide.tooling.impl.internal.ProjectImpl
import com.axiom.rv2ide.tooling.impl.net.SimpleHttpProxy
import com.axiom.rv2ide.tooling.impl.sync.ModelBuilderException
import com.axiom.rv2ide.tooling.impl.sync.RootModelBuilder
import com.axiom.rv2ide.tooling.impl.sync.RootProjectModelBuilderParams
...
internal class ToolingApiServerImpl(private val project: ProjectImpl) : IToolingApiServer {
  ...
  private fun ensureProjectGradleProperties(projectDir: File) {
    try {
      ...
      propsFile.outputStream().use { out ->
        props.store(out, "Axiom ACS: enforce UTF-8 & locale for Gradle daemon")
      }
    } catch (_: Throwable) {
      // best-effort; ignore
    }
  ...
  override fun shutdown(): CompletableFuture<Void> {
    return CompletableFuture.supplyAsync {
      ...
      // see com.axiom.rv2ide.tooling.impl.Main.main(String[])
