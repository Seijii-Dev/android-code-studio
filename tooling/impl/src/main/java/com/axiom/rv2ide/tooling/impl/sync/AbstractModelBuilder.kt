...
import com.axiom.rv2ide.builder.model.IDESyncIssue
import com.axiom.rv2ide.tooling.api.messages.InitializeProjectParams
import com.axiom.rv2ide.tooling.api.util.ToolingProps
import com.axiom.rv2ide.utils.AndroidPluginVersion
import com.axiom.rv2ide.utils.AndroidPluginVersion.Companion.MINIMUM_SUPPORTED
import com.axiom.rv2ide.utils.ILogger
import com.axiom.rv2ide.utils.LogUtils
...
abstract class AbstractModelBuilder<P, R>(
  ...
  companion object {
     ...
     * [ generateMessage(Object...)][com.axiom.rv2ide.utils.ILogger.generateMessage] in
     * [ILogger][com.axiom.rv2ide.utils.ILogger].
     *
