...
package com.axiom.rv2ide.tooling.impl.progress

import com.axiom.rv2ide.tooling.events.StatusEvent
import com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationOperationResult.PluginApplicationResult
...
import com.axiom.rv2ide.tooling.events.transform.TransformOperationDescriptor.SubjectDescriptor
import com.axiom.rv2ide.tooling.events.transform.TransformOperationResult
...
import com.axiom.rv2ide.tooling.model.PluginIdentifier
...
class EventTransformer {
  companion object {
    ...
    ): com.axiom.rv2ide.tooling.events.OperationDescriptor? =
        when (descriptor) {
          null -> null
    ...
    ): com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationProgressEvent =
        com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationStartEvent(
    ...
    fun projectConfigurationFinish(
        ...
        com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationFinishEvent(
            displayName = event.displayName,
            eventTime = event.eventTime,
            descriptor = projectConfigurationDescriptor(event.descriptor),
    ...
    ): com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationOperationResult =
        com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationOperationResult(
    ...
    ): com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationOperationDescriptor =
        com.axiom.rv2ide.tooling.events.configuration.ProjectConfigurationOperationDescriptor(
    ...
    ): com.axiom.rv2ide.tooling.model.ProjectIdentifier =
        com.axiom.rv2ide.tooling.model.ProjectIdentifier(
            projectPath = project.projectPath,
            buildIdentifier =
                com.axiom.rv2ide.tooling.model.BuildIdentifier(project.buildIdentifier.rootDir),
        )
    ...
    ): com.axiom.rv2ide.tooling.events.download.FileDownloadResult =
        com.axiom.rv2ide.tooling.events.download.FileDownloadResult(
    ...
    ): com.axiom.rv2ide.tooling.events.download.FileDownloadOperationDescriptor =
        com.axiom.rv2ide.tooling.events.download.FileDownloadOperationDescriptor(
            descriptor.uri,
            descriptor.name,
    ...
    private fun taskResult(
    ...
    ): com.axiom.rv2ide.tooling.events.task.TaskOperationResult {

      // The order of conditions must not change here.

      if (result is TaskSuccessResult) {
        return com.axiom.rv2ide.tooling.events.task.TaskSuccessResult(
            result.isUpToDate,
            result.isFromCache,
            result.startTime,
            result.endTime,
      ...
      if (result is TaskFailureResult) {
        return com.axiom.rv2ide.tooling.events.task.TaskFailureResult(
            result.startTime,
            result.endTime,
        )
      }
      ...
      if (result is TaskExecutionResult) {
        return com.axiom.rv2ide.tooling.events.task.TaskExecutionResult(
            result.startTime,
            result.endTime,
            result.isIncremental,
            result.executionReasons,
      ...
      if (result is TaskSkippedResult) {
        return com.axiom.rv2ide.tooling.events.task.TaskSkippedResult(
            result.skipMessage,
            result.startTime,
            result.endTime,
        )
      ...
      return com.axiom.rv2ide.tooling.events.task.TaskOperationResult(
          startTime = result.startTime,
          endTime = result.endTime,
      )
    }
    ...
    ): com.axiom.rv2ide.tooling.events.task.TaskOperationDescriptor =
        com.axiom.rv2ide.tooling.events.task.TaskOperationDescriptor(
            dependencies =
    ...
    ): com.axiom.rv2ide.tooling.events.transform.TransformOperationDescriptor =
        com.axiom.rv2ide.tooling.events.transform.TransformOperationDescriptor(
            name = descriptor.name,
            displayName = descriptor.displayName,
    ...
    ): com.axiom.rv2ide.tooling.events.work.WorkItemOperationDescriptor =
        com.axiom.rv2ide.tooling.events.work.WorkItemOperationDescriptor(
            name = descriptor.name,
            displayName = descriptor.displayName,
    ...
    // ----------------------- DEFAULT ----------------------------------
    fun progress(event: ProgressEvent): com.axiom.rv2ide.tooling.events.ProgressEvent =
    ...
    ): com.axiom.rv2ide.tooling.events.ProgressEvent =
        DefaultStartEvent(
            eventTime = event.eventTime,
            displayName = event.displayName,
            descriptor = operationDescriptor(event.descriptor)!!,
