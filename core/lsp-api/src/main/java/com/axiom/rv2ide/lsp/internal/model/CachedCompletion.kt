...
package com.axiom.rv2ide.lsp.internal.model
...
private constructor(
    ...
    val result: com.axiom.rv2ide.lsp.models.CompletionResult,
) {
  ...
  companion object {
    ...
    val EMPTY =
        cache(
            CompletionParams(
                com.axiom.rv2ide.models.Position.NONE,
                Paths.get(""),
                ICancelChecker.CANCELLED,
            ),
            com.axiom.rv2ide.lsp.models.CompletionResult.EMPTY,
        )
    ...
    fun cache(
        ...
        result: com.axiom.rv2ide.lsp.models.CompletionResult,
    ): CachedCompletion {
      val params =
