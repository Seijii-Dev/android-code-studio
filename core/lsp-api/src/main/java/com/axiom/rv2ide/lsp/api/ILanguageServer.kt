 ...
 *   along with AndroidIDE.  If not, see <https://www.gnu.org/licenses/>.
 */
package com.axiom.rv2ide.lsp.api
...
interface ILanguageServer {
   ...
   * [getRootWorkspace()][com.axiom.rv2ide.projects.IProjectManager.workspace] to obtain the workspace
   * instance.
   *
  ...
  suspend fun hover(params: DefinitionParams): com.axiom.rv2ide.lsp.models.MarkupContent {
