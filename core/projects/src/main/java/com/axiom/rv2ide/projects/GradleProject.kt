 ...
 * [IGradleProject][com.axiom.rv2ide.tooling.api.IGradleProject]. This project module caches all the
 * data from an [IGradleProject][com.axiom.rv2ide.tooling.api.IGradleProject] eliminating the use of
 * [CompletableFuture] s.
 *
