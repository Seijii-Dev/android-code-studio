...
package com.axiom.rv2ide.artificial.agents

import android.content.Context
import com.axiom.rv2ide.artificial.agents.google.Gemini
import com.axiom.rv2ide.artificial.agents.openai.OpenAI
import com.axiom.rv2ide.artificial.agents.anthropic.Anthropic
import com.axiom.rv2ide.artificial.agents.grok.Grok
import com.axiom.rv2ide.artificial.agents.deepseek.DeepSeek
import com.axiom.rv2ide.artificial.agents.local.LocalLLM
import com.axiom.rv2ide.artificial.file.FileWriteResult
import com.axiom.rv2ide.artificial.parser.SnippetParser
import com.axiom.rv2ide.artificial.permissions.AIPermissionManager
import com.axiom.rv2ide.artificial.project.awareness.ProjectData
import com.axiom.rv2ide.artificial.secrets.ApiKey
import java.io.File
import kotlinx.coroutines.delay
import com.axiom.rv2ide.artificial.dialogs.ProviderSwitchDialog
...
class AIAgentManager(private val context: Context) {
            ...
            try {
                ...
                result.fold(
                  ...
                  onFailure = { error ->
                      ...
                      val shouldSwitchProvider = error is com.axiom.rv2ide.artificial.exceptions.RateLimitException ||
                                                error is com.axiom.rv2ide.artificial.exceptions.QuotaExceededException ||
                                                error is com.axiom.rv2ide.artificial.exceptions.InsufficientBalanceException ||
                                                error is com.axiom.rv2ide.artificial.exceptions.InvalidApiKeyException
    ...
    private fun formatErrorMessage(error: Throwable): String {
        ...
        return when (error) {
            is com.axiom.rv2ide.artificial.exceptions.RateLimitException -> 
                "⚠️ RATE LIMIT EXCEEDED\n\nThe API rate limit has been exceeded.\nPlease wait a few minutes before trying again.\n\nDetails: $errorMessage"
            is com.axiom.rv2ide.artificial.exceptions.QuotaExceededException -> 
                "⚠️ QUOTA EXCEEDED\n\nYour API quota has been exhausted.\nPlease check your billing or upgrade your plan.\n\nDetails: $errorMessage"
            is com.axiom.rv2ide.artificial.exceptions.InsufficientBalanceException -> 
                "💳 INSUFFICIENT BALANCE\n\nYour account balance is too low to process this request.\nPlease add credits or upgrade your plan.\n\nProvider: $providerName\n\nDetails: $errorMessage"
            is com.axiom.rv2ide.artificial.exceptions.InvalidApiKeyException -> 
