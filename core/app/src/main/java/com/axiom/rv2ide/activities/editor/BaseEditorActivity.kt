...
package com.axiom.rv2ide.activities.editor
...
import com.axiom.rv2ide.R
import com.axiom.rv2ide.R.string
import com.axiom.rv2ide.actions.ActionItem.Location.EDITOR_FILE_TABS
import com.axiom.rv2ide.adapters.DiagnosticsAdapter
import com.axiom.rv2ide.adapters.SearchListAdapter
import com.axiom.rv2ide.app.EdgeToEdgeIDEActivity
import com.axiom.rv2ide.databinding.ActivityEditorBinding
import com.axiom.rv2ide.databinding.ContentEditorBinding
import com.axiom.rv2ide.databinding.LayoutDiagnosticInfoBinding
import com.axiom.rv2ide.events.InstallationResultEvent
import com.axiom.rv2ide.fragments.SearchResultFragment
import com.axiom.rv2ide.fragments.sidebar.EditorSidebarFragment
import com.axiom.rv2ide.fragments.sidebar.FileTreeFragment
import com.axiom.rv2ide.handlers.EditorActivityLifecyclerObserver
import com.axiom.rv2ide.handlers.LspHandler.registerLanguageServers
import com.axiom.rv2ide.interfaces.DiagnosticClickListener
import com.axiom.rv2ide.lookup.Lookup
import com.axiom.rv2ide.lsp.models.DiagnosticItem
import com.axiom.rv2ide.models.DiagnosticGroup
import com.axiom.rv2ide.models.OpenedFile
import com.axiom.rv2ide.models.Range
import com.axiom.rv2ide.models.SearchResult
import com.axiom.rv2ide.preferences.internal.BuildPreferences
import com.axiom.rv2ide.projectdata.state.lsp.Index
import com.axiom.rv2ide.indexing.views.IndexingBanner
import com.axiom.rv2ide.projectdata.state.Initialization
import com.axiom.rv2ide.projectdata.logs.LogStream
import com.axiom.rv2ide.projects.IProjectManager
import com.axiom.rv2ide.tasks.cancelIfActive
import com.axiom.rv2ide.ui.CodeEditorView
import com.axiom.rv2ide.ui.ContentTranslatingDrawerLayout
import com.axiom.rv2ide.ui.SwipeRevealLayout
import com.axiom.rv2ide.uidesigner.UIDesignerActivity
import com.axiom.rv2ide.utils.ActionMenuUtils.createMenu
import com.axiom.rv2ide.utils.ApkInstallationSessionCallback
import com.axiom.rv2ide.utils.DialogUtils.newMaterialDialogBuilder
import com.axiom.rv2ide.utils.Environment
import com.axiom.rv2ide.utils.InstallationResultHandler.onResult
import com.axiom.rv2ide.utils.IntentUtils
import com.axiom.rv2ide.utils.MemoryUsageWatcher
import com.axiom.rv2ide.utils.flashError
import com.axiom.rv2ide.utils.flashInfo
import com.axiom.rv2ide.utils.flashSuccess
import com.axiom.rv2ide.utils.resolveAttr
import com.axiom.rv2ide.viewmodel.EditorViewModel
import com.axiom.rv2ide.xml.resources.ResourceTableRegistry
import com.axiom.rv2ide.xml.versions.ApiVersionsRegistry
import com.axiom.rv2ide.xml.widgets.WidgetTableRegistry
import com.axiom.rv2ide.setup.Setup
import com.axiom.rv2ide.experimental.depsupdater.DependencyUpdaterDialog
import com.axiom.rv2ide.preferences.internal.BuildPreferences.isKtIndexingNotificationEnabled
import java.io.File
...
override fun onApplySystemBarInsets(insets: Insets) {
  ...
  private fun setupMemUsageChart() {
    binding.memUsageView.chart.apply {
      ...
      (application as? com.axiom.rv2ide.app.IDEApplication)
          ?.getChartCleanupTask()
          ?.registerChart(this)
    }
  }
