...
import com.axiom.rv2ide.activities.editor.BaseEditorActivity
import com.axiom.rv2ide.app.BaseApplication
import com.axiom.rv2ide.editor.api.IEditor
import com.axiom.rv2ide.editor.databinding.LayoutCodeEditorBinding
import com.axiom.rv2ide.editor.ui.EditorSearchLayout
import com.axiom.rv2ide.editor.ui.IDEEditor
import com.axiom.rv2ide.editor.ui.IDEEditor.Companion.createInputTypeFlags
import com.axiom.rv2ide.editor.ui.cleanupCompletionTooltips
import com.axiom.rv2ide.editor.ui.cleanupHoverTooltips
import com.axiom.rv2ide.editor.ui.clearDiagnostics
import com.axiom.rv2ide.editor.ui.initCompletionTooltips
import com.axiom.rv2ide.editor.ui.initDiagnosticHandling
import com.axiom.rv2ide.editor.ui.initHoverTooltips
import com.axiom.rv2ide.editor.ui.updateEditorDiagnostics
import com.axiom.rv2ide.editor.utils.ContentReadWrite.readContent
import com.axiom.rv2ide.editor.utils.ContentReadWrite.writeTo
import com.axiom.rv2ide.eventbus.events.preferences.PreferenceChangeEvent
...
import com.axiom.rv2ide.utils.customOrJBMono
import com.axiom.rv2ide.artificial.completion.SuggestionView
...
import com.axiom.rv2ide.managers.PreferenceManager
...
class CodeEditorView(context: Context, file: File, selection: Range) :
  ...
  private fun onCustomFontPrefChanged() {
    ...
    var fontPath = "${com.axiom.rv2ide.utils.Environment.HOME}/.androidide/ui/${EditorPreferences.selectedCustomFont}"
    if (fontPath == "${com.axiom.rv2ide.utils.Environment.HOME}/.androidide/ui/null") {
      fontPath = "${com.axiom.rv2ide.utils.Environment.HOME}/.androidide/ui/jetbrains-mono.ttf"
    }
