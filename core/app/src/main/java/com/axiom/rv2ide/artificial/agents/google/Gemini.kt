...
package com.axiom.rv2ide.artificial.agents.google
          ...
          val response = try {
            ...
            when {
              ...
              errorMessage.contains("429") -> 
                throw com.axiom.rv2ide.artificial.exceptions.QuotaExceededException(
                  "Gemini API quota exceeded. Switching to another provider..."
                )
              errorMessage.contains("RATE_LIMIT") ||
              errorMessage.contains("rate limit") -> 
                throw com.axiom.rv2ide.artificial.exceptions.RateLimitException(
                  "Gemini rate limit exceeded. Switching to another provider..."
                )
              errorMessage.contains("INVALID_ARGUMENT") ||
              errorMessage.contains("API key") -> 
                throw com.axiom.rv2ide.artificial.exceptions.InvalidApiKeyException(
