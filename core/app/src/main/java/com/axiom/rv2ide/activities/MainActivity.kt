...
package com.axiom.rv2ide.activities
...
import com.axiom.rv2ide.activities.editor.EditorActivityKt
import com.axiom.rv2ide.app.EdgeToEdgeIDEActivity
import com.axiom.rv2ide.databinding.ActivityMainBinding
...
import com.axiom.rv2ide.templates.ITemplateProvider
...
import com.axiom.rv2ide.viewmodel.MainViewModel.Companion.SCREEN_MAIN
import com.axiom.rv2ide.viewmodel.MainViewModel.Companion.SCREEN_TEMPLATE_DETAILS
import com.axiom.rv2ide.viewmodel.MainViewModel.Companion.SCREEN_TEMPLATE_LIST
import com.axiom.rv2ide.setup.updater.lsp.KotlinLspUpdater
import com.axiom.rv2ide.setup.updater.lsp.data.LSPProperties
import java.io.File
    ...
    val currentFragment =
        when (screen) {
          ...
          SCREEN_TEMPLATE_LIST ->
              com.axiom.rv2ide.templates.AtcInterface().create(this)
