...
import com.axiom.rv2ide.actions.SidebarActionItem
import com.axiom.rv2ide.actions.internal.DefaultActionsRegistry
import com.axiom.rv2ide.actions.sidebar.AIAgentSidebarAction
import com.axiom.rv2ide.actions.sidebar.AssetStudioSidebarAction
import com.axiom.rv2ide.actions.sidebar.BuildVariantsSidebarAction
import com.axiom.rv2ide.actions.sidebar.CloseProjectSidebarAction
import com.axiom.rv2ide.actions.sidebar.FileTreeSidebarAction
import com.axiom.rv2ide.actions.sidebar.PreferencesSidebarAction
import com.axiom.rv2ide.actions.sidebar.SubModuleSidebarAction
import com.axiom.rv2ide.actions.sidebar.GitClientAction
import com.axiom.rv2ide.actions.sidebar.TerminalSidebarAction
  ...
  fun setup(sidebarFragment: EditorSidebarFragment) {
    ...
    val navigationRecycler =
        binding.navigation.findViewById<androidx.recyclerview.widget.RecyclerView>(
            com.axiom.rv2ide.R.id.navigation_recycler
        )
