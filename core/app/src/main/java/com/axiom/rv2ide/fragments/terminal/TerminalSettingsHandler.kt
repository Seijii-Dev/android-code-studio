...
class TerminalSettingsHandler(
    ...
    private fun setupTextSizeSlider(rootView: View, savedTextSize: Int) {
        val textSizeSlider = rootView.findViewById<Slider>(com.axiom.rv2ide.R.id.text_size_slider)
        val textSizeValue = rootView.findViewById<TextView>(com.axiom.rv2ide.R.id.text_size_value)
    ...
    private fun setupExtraKeysSwitch(rootView: View) {
        val extraKeysSwitch = rootView.findViewById<MaterialSwitch>(com.axiom.rv2ide.R.id.hide_extra_keys)
