...
package com.axiom.rv2ide.artificial.agents.openai

import android.content.Context
import com.axiom.rv2ide.artificial.services.ArtificialService
import com.axiom.rv2ide.artificial.rules.WritingRules
import com.axiom.rv2ide.artificial.project.awareness.ProjectTreeResult
import com.axiom.rv2ide.artificial.file.AIFileWriter
import com.axiom.rv2ide.artificial.file.FileWriteResult
import kotlinx.coroutines.Dispatchers
import kotlinx.coroutines.withContext
import java.io.File
import com.axiom.rv2ide.artificial.agents.Agents
import org.json.JSONObject
import org.json.JSONArray
import java.net.HttpURLConnection
import java.net.URL
import com.axiom.rv2ide.artificial.exceptions.*
import com.axiom.rv2ide.artificial.agents.AIAgent
import com.axiom.rv2ide.artificial.agents.AIAgentRegistry
import com.axiom.rv2ide.artificial.secrets.ApiKey
import com.axiom.rv2ide.artificial.agents.ModificationAttempt
...
class OpenAI : AIAgent {
        ...
        try {
          ...
          when {
            responseCode == 429 || errorType.contains("rate_limit") || errorCode.contains("rate_limit") -> 
              throw com.axiom.rv2ide.artificial.exceptions.RateLimitException("OpenAI rate limit exceeded: $errorMessage")
            errorType.contains("insufficient_quota") || errorMessage.contains("quota") || errorMessage.contains("billing") -> 
              throw com.axiom.rv2ide.artificial.exceptions.QuotaExceededException("OpenAI quota exceeded: $errorMessage")
            errorType.contains("invalid_api_key") || errorCode.contains("invalid_api_key") -> 
              throw com.axiom.rv2ide.artificial.exceptions.InvalidApiKeyException("Invalid OpenAI API key: $errorMessage")
            responseCode == 401 -> 
              throw com.axiom.rv2ide.artificial.exceptions.InvalidApiKeyException("OpenAI authentication failed: $errorMessage")
            else -> 
              throw Exception("OpenAI API error ($responseCode) - Type: $errorType, Code: $errorCode, Message: $errorMessage")
          }
        } catch (e: com.axiom.rv2ide.artificial.exceptions.RateLimitException) {
          throw e
        } catch (e: com.axiom.rv2ide.artificial.exceptions.QuotaExceededException) {
          throw e
        } catch (e: com.axiom.rv2ide.artificial.exceptions.InvalidApiKeyException) {
          throw e
        } catch (e: Exception) {
  ...
  fun parseAndApplyModifications(response: String, capturedStates: Map<String, String>): List<FileModification> {
    ...
    val parser = com.axiom.rv2ide.artificial.parser.SnippetParser()
