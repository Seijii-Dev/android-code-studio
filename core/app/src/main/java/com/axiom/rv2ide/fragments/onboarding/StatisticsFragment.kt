...
import com.axiom.rv2ide.app.IDEApplication
import com.axiom.rv2ide.databinding.LayoutOnboardingStatisticsBinding
...
class StatisticsFragment : OnboardingFragment() {
  ...
  fun updateStatOptInStatus() {
    com.axiom.rv2ide.preferences.internal.StatPreferences.statOptIn =
