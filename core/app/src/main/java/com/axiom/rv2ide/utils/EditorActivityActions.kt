 ...
 */
package com.axiom.rv2ide.utils

import android.content.Context
import com.axiom.rv2ide.actions.ActionItem.Location.EDITOR_FILE_TABS
import com.axiom.rv2ide.actions.ActionItem.Location.EDITOR_FILE_TREE
import com.axiom.rv2ide.actions.ActionItem.Location.EDITOR_TOOLBAR
import com.axiom.rv2ide.actions.ActionsRegistry
import com.axiom.rv2ide.actions.build.ProjectSyncAction
import com.axiom.rv2ide.actions.build.QuickRunWithCancellationAction
import com.axiom.rv2ide.actions.build.RunTasksAction
import com.axiom.rv2ide.actions.editor.CopyAction
import com.axiom.rv2ide.actions.editor.CutAction
import com.axiom.rv2ide.actions.editor.ExpandSelectionAction
import com.axiom.rv2ide.actions.editor.ExtractAction
import com.axiom.rv2ide.actions.editor.LongSelectAction
import com.axiom.rv2ide.actions.editor.PasteAction
import com.axiom.rv2ide.actions.editor.SelectAllAction
import com.axiom.rv2ide.actions.etc.DisconnectLogSendersAction
import com.axiom.rv2ide.actions.etc.FindActionMenu
import com.axiom.rv2ide.actions.etc.ColorSchemeMenu
import com.axiom.rv2ide.actions.etc.IdeConfigurationsAction
import com.axiom.rv2ide.actions.etc.TextActionMenuAction
import com.axiom.rv2ide.actions.etc.LaunchAppAction
import com.axiom.rv2ide.actions.etc.PreviewLayoutAction
import com.axiom.rv2ide.actions.etc.ReloadColorSchemesAction
import com.axiom.rv2ide.actions.file.CloseAllFilesAction
import com.axiom.rv2ide.actions.file.CloseFileAction
import com.axiom.rv2ide.actions.file.CloseOtherFilesAction
import com.axiom.rv2ide.actions.file.FormatCodeAction
import com.axiom.rv2ide.actions.file.SaveFileAction
import com.axiom.rv2ide.actions.filetree.CopyPathAction
import com.axiom.rv2ide.actions.filetree.DeleteAction
import com.axiom.rv2ide.actions.filetree.NewFileAction
import com.axiom.rv2ide.actions.filetree.NewFolderAction
import com.axiom.rv2ide.actions.filetree.OpenWithAction
import com.axiom.rv2ide.actions.filetree.RenameAction
import com.axiom.rv2ide.actions.text.RedoAction
import com.axiom.rv2ide.actions.text.UndoAction
