package com.axiom.rv2ide.templates
...
import com.axiom.rv2ide.activities.FolderPickerActivity
import com.axiom.rv2ide.activities.IDEConfigurations
import com.axiom.rv2ide.databinding.DialogAtcWizardBinding
import com.axiom.rv2ide.templates.android.Template
import com.axiom.rv2ide.templates.android.TemplateOptions
import com.axiom.rv2ide.templates.android.TemplateRegistry
import com.axiom.rv2ide.templates.android.etc.NativeCpp.Check
import com.axiom.rv2ide.templates.preferences.Options
...
class AtcWizardDialog : BottomSheetDialogFragment() {
  ...
  private fun requireAcsHomeProjectsDir() {
    showAlert(
        ...
        "Game projects must be saved in the Axiom ACS home directory to work correctly.",
...
internal object SafResolver {
  ...
  private const val ANDROIDIDE_DOCS_AUTHORITY = "com.axiom.rv2ide.documents"
