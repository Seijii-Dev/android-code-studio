...
package com.axiom.rv2ide.actions.build
...
import com.axiom.rv2ide.actions.BaseBuildAction
import com.axiom.rv2ide.actions.getContext
import com.axiom.rv2ide.actions.markInvisible
import com.axiom.rv2ide.actions.openApplicationModuleChooser
...
import com.axiom.rv2ide.models.ApkMetadata
...
import com.axiom.rv2ide.ui.InstallingDialog
import com.axiom.rv2ide.utils.ApkInstaller
import com.axiom.rv2ide.utils.InstallationResultHandler
...
class QuickRunWithCancellationAction(context: Context, override val order: Int) :
  ...
  private fun cancelBuild(): Boolean {
    ...
    if (builder?.isToolingServerStarted() != true) {
      flashError(com.axiom.rv2ide.projects.R.string.msg_tooling_server_unavailable)
      return false
    }
