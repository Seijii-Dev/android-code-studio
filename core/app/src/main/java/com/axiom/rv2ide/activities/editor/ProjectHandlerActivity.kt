...
import com.axiom.rv2ide.databinding.LayoutSearchProjectBinding
import com.axiom.rv2ide.flashbar.Flashbar
import com.axiom.rv2ide.fragments.sheets.ProgressSheet
import com.axiom.rv2ide.handlers.EditorBuildEventListener
import com.axiom.rv2ide.handlers.LspHandler.connectClient
import com.axiom.rv2ide.handlers.LspHandler.destroyLanguageServers
import com.axiom.rv2ide.lookup.Lookup
import com.axiom.rv2ide.lsp.IDELanguageClientImpl
import com.axiom.rv2ide.lsp.java.utils.CancelChecker
import com.axiom.rv2ide.preferences.internal.GeneralPreferences
import com.axiom.rv2ide.projects.GradleProject
import com.axiom.rv2ide.projects.builder.BuildService
import com.axiom.rv2ide.projects.internal.ProjectManagerImpl
import com.axiom.rv2ide.services.builder.GradleBuildService
import com.axiom.rv2ide.services.builder.GradleBuildServiceConnnection
import com.axiom.rv2ide.services.builder.gradleDistributionParams
import com.axiom.rv2ide.tasks.executeAsyncProvideError
import com.axiom.rv2ide.tasks.executeWithProgress
import com.axiom.rv2ide.tooling.api.messages.AndroidInitializationParams
...
import com.axiom.rv2ide.tooling.api.models.BuildVariantInfo
import com.axiom.rv2ide.tooling.api.models.mapToSelectedVariants
import com.axiom.rv2ide.utils.DURATION_INDEFINITE
import com.axiom.rv2ide.utils.DialogUtils.newMaterialDialogBuilder
import com.axiom.rv2ide.utils.RecursiveFileSearcher
import com.axiom.rv2ide.utils.flashError
import com.axiom.rv2ide.utils.flashbarBuilder
import com.axiom.rv2ide.utils.resolveAttr
import com.axiom.rv2ide.utils.showOnUiThread
import com.axiom.rv2ide.utils.withIcon
import com.axiom.rv2ide.viewmodel.BuildVariantsViewModel
import java.io.File
  ...
  fun initializeProject(buildVariantsProvider: () -> Map<String, String>) {
    executeWithProgress { progress ->
      executeAsyncProvideError(buildVariantsProvider::invoke) { result, error ->
        com.axiom.rv2ide.tasks.runOnUiThread { progress.dismiss() }
        ...
        com.axiom.rv2ide.tasks.runOnUiThread { initializeProject(result) }
      }
    }
  }
...
fun initializeProject(buildVariants: Map<String, String>) {
  ...
  protected open fun onProjectInitialized(result: InitializeResult) {
    ...
    editorActivityScope.launch(Dispatchers.IO) {
      try {
        ...
        if (workspace == null) {
          com.axiom.rv2ide.tasks.runOnUiThread {
        ...
        com.axiom.rv2ide.tasks.runOnUiThread { postProjectInit(true, null) }
      } catch (e: Exception) {
  ...
  private fun initialSetup() {
    ...
    try {
      ...
      // supportActionBar!!.setTitle("Axiom ACS")
    } catch (th: Throwable) {
      // ignored
    }
  }
