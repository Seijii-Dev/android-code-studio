...
import com.axiom.rv2ide.shell.executeProcessAsync
...
import com.axiom.rv2ide.tooling.api.util.ToolingApiLauncher
            ...
            try {
              ...
              val command =
                  listOf(
                      ...
                      "-D${CoreConstants.STATUS_LISTENER_CLASS_KEY}=com.axiom.rv2ide.tooling.impl.util.LogbackStatusListener",
                      "-jar",
