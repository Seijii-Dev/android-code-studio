package com.axiom.rv2ide.fragments.terminal
...
class ExtraKeysHandler(
    ...
    fun setup() {
        extraKeysLayout = rootView.findViewById(com.axiom.rv2ide.R.id.extra_keys_include)
        
        ctrlButton = extraKeysLayout?.findViewById(com.axiom.rv2ide.R.id.key_ctrl)
        altButton = extraKeysLayout?.findViewById(com.axiom.rv2ide.R.id.key_alt)
    ...
    private fun setupKeyCodeButtons() {
        mapOf(
            com.axiom.rv2ide.R.id.key_esc to KeyEvent.KEYCODE_ESCAPE,
            com.axiom.rv2ide.R.id.key_tab to KeyEvent.KEYCODE_TAB,
            com.axiom.rv2ide.R.id.key_up to KeyEvent.KEYCODE_DPAD_UP,
            com.axiom.rv2ide.R.id.key_down to KeyEvent.KEYCODE_DPAD_DOWN,
            com.axiom.rv2ide.R.id.key_left to KeyEvent.KEYCODE_DPAD_LEFT,
            com.axiom.rv2ide.R.id.key_right to KeyEvent.KEYCODE_DPAD_RIGHT,
            com.axiom.rv2ide.R.id.key_home to KeyEvent.KEYCODE_MOVE_HOME,
            com.axiom.rv2ide.R.id.key_end to KeyEvent.KEYCODE_MOVE_END,
            com.axiom.rv2ide.R.id.key_pgup to KeyEvent.KEYCODE_PAGE_UP,
            com.axiom.rv2ide.R.id.key_pgdn to KeyEvent.KEYCODE_PAGE_DOWN
        ).forEach { (id, keyCode) ->
    ...
    private fun setupTextButtons() {
        mapOf(
            com.axiom.rv2ide.R.id.key_slash to "/",
            com.axiom.rv2ide.R.id.key_minus to "-",
            com.axiom.rv2ide.R.id.key_pipe to "|"
        ).forEach { (id, text) ->
            rootView.findViewById<MaterialButton>(id)?.setOnClickListener { 
                sendText(text)
                resetModifiers()
