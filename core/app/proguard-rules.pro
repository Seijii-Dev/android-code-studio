...
# Tooling API classes
-keep class com.axiom.rv2ide.tooling.** { *; }

# Builder model implementations
-keep class com.axiom.rv2ide.builder.model.** { *; }
...
-keep class com.axiom.rv2ide.projects.util.StringSearch {
    packageName(java.nio.file.Path);
}
-keep class * implements org.antlr.v4.runtime.Lexer {
    <init>(...);
}
-keep class * extends com.axiom.rv2ide.lsp.java.providers.completion.IJavaCompletionProvider {
    <init>(...);
}
-keep class com.axiom.rv2ide.editor.api.IEditor { *; }
-keep class * extends com.axiom.rv2ide.inflater.IViewAdapter { *; }
-keep class * extends com.axiom.rv2ide.inflater.drawable.IDrawableParser {
    <init>(...);
    android.graphics.drawable.Drawable parse();
    android.graphics.drawable.Drawable parseDrawable();
}
-keep class com.axiom.rv2ide.utils.DialogUtils {  public <methods>; }

# APK Metadata
-keep class com.axiom.rv2ide.models.ApkMetadata { *; }
-keep class com.axiom.rv2ide.models.ArtifactType { *; }
-keep class com.axiom.rv2ide.models.MetadataElement { *; }
...
-keep enum com.axiom.rv2ide.xml.permissions.Permission { *; }
...
-keep class com.axiom.rv2ide.treesitter.** { *; }
...
# Stat uploader
-keep class com.axiom.rv2ide.stats.** { *; }
...
## Themes
-keep enum com.axiom.rv2ide.ui.themes.IDETheme {
  *;
}

## Contributor models - deserialized with GSON
-keep class * implements com.axiom.rv2ide.contributors.Contributor {
  *;
}
