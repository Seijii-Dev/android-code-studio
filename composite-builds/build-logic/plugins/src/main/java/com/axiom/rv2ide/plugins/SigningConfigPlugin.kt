...
import com.axiom.rv2ide.build.config.SigningConfig
import com.axiom.rv2ide.build.config.loadSigningProperties
...
class SigningConfigPlugin : Plugin<Project> {
  ...
  private fun Project.findSigningConfiguration(): SigningConfig? {
    ...
    val envKeyAlias = System.getenv("SIGNING_KEY_ALIAS") ?: "Axiom ACS"
    ...
    val gradleKeyAlias = findProperty("signingKeyAlias") as? String ?: "Axiom ACS"
