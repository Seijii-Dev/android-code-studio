...
package com.axiom.rv2ide.setup
...
import com.axiom.rv2ide.setup.R
import com.axiom.rv2ide.resources.R.string
import com.axiom.rv2ide.setup.servers.ILanguageServerInstaller
...
class Setup(private val context: Context) {
  ...
  private fun installLanguageServer(serverId: String, onComplete: ((Boolean) -> Unit)?) {
    ...
    val outputText = progressView.findViewById<com.axiom.rv2ide.editor.ui.IDEEditor>(R.id.tv_output)
  ...
  private fun getLanguageServerInstaller(serverId: String): ILanguageServerInstaller {
    val className = "com.axiom.rv2ide.setup.servers.${serverId}.${serverId.capitalize()}"
