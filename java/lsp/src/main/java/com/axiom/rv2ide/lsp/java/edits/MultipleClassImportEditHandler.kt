...
package com.axiom.rv2ide.lsp.java.edits
...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
      ...
      editor: CodeEditor,
      completionItem: com.axiom.rv2ide.lsp.models.CompletionItem,
  ) {
    val edits = mutableListOf<com.axiom.rv2ide.lsp.models.TextEdit>()
    ...
    com.axiom.rv2ide.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
