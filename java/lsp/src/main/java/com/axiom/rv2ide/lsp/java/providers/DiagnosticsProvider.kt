...
import com.axiom.rv2ide.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import com.axiom.rv2ide.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import com.axiom.rv2ide.lsp.java.visitors.DiagnosticVisitor
import com.axiom.rv2ide.lsp.models.DiagnosticItem
import com.axiom.rv2ide.lsp.models.DiagnosticSeverity
import com.axiom.rv2ide.lsp.models.DiagnosticSeverity.WARNING
...
import com.axiom.rv2ide.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): com.axiom.rv2ide.models.Position {
    abortIfCancelled()
    ...
    return com.axiom.rv2ide.models.Position(line, column)
  }
