 ...
 */
package com.axiom.rv2ide.lsp.kotlin
...
import com.axiom.rv2ide.lsp.kotlin.compiler.KotlinCompilerService
import com.axiom.rv2ide.lsp.kotlin.etc.LspFeatures
import com.axiom.rv2ide.lsp.kotlin.providers.KotlinCodeFormatProvider
import com.axiom.rv2ide.lsp.models.*
...
class KotlinLanguageServer(private val context: Context) : ILanguageServer {
  ...
  private val analyzeTimer = com.axiom.rv2ide.lsp.java.utils.AnalyzeTimer { analyzeSelected() }
  ...
  private fun findCompilerService(workspace: IWorkspace): KotlinCompilerService? {
    val mainModule =
        workspace
            .getSubProjects()
            .filterIsInstance<com.axiom.rv2ide.projects.android.AndroidModule>()
