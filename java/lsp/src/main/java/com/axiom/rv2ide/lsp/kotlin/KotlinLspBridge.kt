    ...
    p0?.let { params ->
      val diagnostics =
          params.diagnostics.map { diagnostic ->
            com.axiom.rv2ide.lsp.models.DiagnosticItem(
                message = diagnostic.message,
                code = diagnostic.code?.toString() ?: "",
                range =
                    com.axiom.rv2ide.models.Range(
                        start =
                            com.axiom.rv2ide.models.Position(
                ...
                severity =
                    when (diagnostic.severity) {
                      org.eclipse.lsp4j.DiagnosticSeverity.Error ->
                          com.axiom.rv2ide.lsp.models.DiagnosticSeverity.ERROR
                      org.eclipse.lsp4j.DiagnosticSeverity.Warning ->
                          com.axiom.rv2ide.lsp.models.DiagnosticSeverity.WARNING
                      org.eclipse.lsp4j.DiagnosticSeverity.Information ->
                          com.axiom.rv2ide.lsp.models.DiagnosticSeverity.INFO
                      org.eclipse.lsp4j.DiagnosticSeverity.Hint ->
                          com.axiom.rv2ide.lsp.models.DiagnosticSeverity.HINT
                      else -> com.axiom.rv2ide.lsp.models.DiagnosticSeverity.ERROR
                    },
            )
          }
      ideClient.publishDiagnostics(
          com.axiom.rv2ide.lsp.models.DiagnosticResult(
