...
class KotlinRequestHandler(
  ...
  private fun extractPrefix(content: String, position: com.axiom.rv2ide.models.Position): String {
  ...
  private fun convertToLocations(result: JsonObject?): List<com.axiom.rv2ide.models.Location> {
    return result?.asJsonArray?.map { element ->
      ...
      com.axiom.rv2ide.models.Location(
