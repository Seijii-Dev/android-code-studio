package com.axiom.rv2ide.lsp.java.actions.common
...
import com.axiom.rv2ide.actions.requireEditor
...
class OrganizeImportsAction : BaseJavaCodeAction() {
  ...
  override suspend fun execAction(data: ActionData): Any {
    val watch = com.axiom.rv2ide.utils.StopWatch("Organize imports")
    return try {
