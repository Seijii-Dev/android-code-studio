...
package com.axiom.rv2ide.lsp.java.compiler;
...
import com.axiom.rv2ide.javac.config.JavacConfigProvider;
import com.axiom.rv2ide.javac.services.fs.AndroidFsProviderImpl;
import com.axiom.rv2ide.projects.android.AndroidModule;
import com.axiom.rv2ide.projects.ModuleProject;
import com.axiom.rv2ide.projects.util.StringSearch;
import com.axiom.rv2ide.utils.ClassTrie;
import com.axiom.rv2ide.utils.Environment;
import com.axiom.rv2ide.utils.SourceClassTrie;
import java.io.File;
...
public class SourceFileManager extends ForwardingJavaFileManager<JavacFileManager> {
  ...
  private SourceFileManager(final ModuleProject module) {
    ...
    com.axiom.rv2ide.projectdata.logs.LogStream.INSTANCE.emitLineBlocking("Configuring source paths...");
    setLocationLogError(StandardLocation.SOURCE_PATH, module.getCompileSourceDirectories());
    
    com.axiom.rv2ide.projectdata.logs.LogStream.INSTANCE.emitLineBlocking("Configuring classpaths...");
    setLocationLogError(StandardLocation.CLASS_PATH, configureClasspaths(module));
    
    com.axiom.rv2ide.projectdata.logs.LogStream.INSTANCE.emitLineBlocking("Indexing project files...");
    listLocations(EnumSet.of(StandardLocation.CLASS_PATH, StandardLocation.PLATFORM_CLASS_PATH));
    
    com.axiom.rv2ide.projectdata.logs.LogStream.INSTANCE.emitLineBlocking("File manager initialization complete!");
    
    // Clear indexing flag after initialization
    com.axiom.rv2ide.projectdata.state.lsp.Index.INSTANCE.setIsIndexing(false);
  }
  ...
  private static SourceFileManager createForModule(@NonNull ModuleProject project) {
    ...
    com.axiom.rv2ide.projectdata.state.lsp.Index.INSTANCE.setIsIndexing(true);
    
    com.axiom.rv2ide.projectdata.logs.LogStream.INSTANCE.emitLineBlocking("Initializing file manager for: " + project.getName());
