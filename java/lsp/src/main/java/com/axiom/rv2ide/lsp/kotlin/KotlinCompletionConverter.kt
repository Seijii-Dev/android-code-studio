...
import com.axiom.rv2ide.lsp.models.InsertTextFormat
      ...
      classes.map { classInfo ->
        ...
        val additionalEdits =
            if (needsImport) {
              ...
              listOf(
                  com.axiom.rv2ide.lsp.models.TextEdit(
                      range =
                          com.axiom.rv2ide.models.Range(
                              start = com.axiom.rv2ide.models.Position(line, 0),
                              end = com.axiom.rv2ide.models.Position(line, 0),
                          ),
                      newText = importText,
                  )
              )
        ...
        CompletionItem(
            ...
            command = null,
            completionKind = com.axiom.rv2ide.lsp.models.CompletionItemKind.CLASS,
            matchLevel = com.axiom.rv2ide.lsp.models.MatchLevel.CASE_SENSITIVE_PREFIX,
