...
import com.axiom.rv2ide.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
import com.axiom.rv2ide.lsp.models.CompletionItem
import com.axiom.rv2ide.lsp.models.CompletionResult
import com.axiom.rv2ide.lsp.models.MatchLevel.CASE_SENSITIVE_EQUAL
...
import com.axiom.rv2ide.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.axiom.rv2ide.utils.ClassTrie, pkgName: String): Node? {
