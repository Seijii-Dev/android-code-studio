 ...
 */
package com.axiom.rv2ide.lsp.java

import androidx.annotation.RestrictTo
import com.axiom.rv2ide.eventbus.events.editor.DocumentChangeEvent
import com.axiom.rv2ide.eventbus.events.editor.DocumentCloseEvent
import com.axiom.rv2ide.eventbus.events.editor.DocumentOpenEvent
import com.axiom.rv2ide.eventbus.events.editor.DocumentSelectedEvent
import com.axiom.rv2ide.javac.services.fs.CacheFSInfoSingleton
import com.axiom.rv2ide.javac.services.fs.CachingJarFileSystemProvider.clearCache
import com.axiom.rv2ide.javac.services.fs.CachingJarFileSystemProvider.clearCachesForPaths
import com.axiom.rv2ide.lsp.api.ILanguageClient
import com.axiom.rv2ide.lsp.api.ILanguageServer
import com.axiom.rv2ide.lsp.api.IServerSettings
import com.axiom.rv2ide.lsp.internal.model.CachedCompletion
import com.axiom.rv2ide.lsp.java.actions.JavaCodeActionsMenu
import com.axiom.rv2ide.lsp.java.compiler.JavaCompilerService
import com.axiom.rv2ide.lsp.java.compiler.SourceFileManager
import com.axiom.rv2ide.lsp.java.models.JavaServerSettings
import com.axiom.rv2ide.lsp.java.providers.CodeFormatProvider
import com.axiom.rv2ide.lsp.java.providers.CompletionProvider
import com.axiom.rv2ide.lsp.java.providers.DefinitionProvider
import com.axiom.rv2ide.lsp.java.providers.JavaDiagnosticProvider
import com.axiom.rv2ide.lsp.java.providers.JavaSelectionProvider
import com.axiom.rv2ide.lsp.java.providers.ReferenceProvider
import com.axiom.rv2ide.lsp.java.providers.SignatureProvider
import com.axiom.rv2ide.lsp.java.providers.snippet.JavaSnippetRepository.init
import com.axiom.rv2ide.lsp.java.utils.AnalyzeTimer
import com.axiom.rv2ide.lsp.java.utils.CancelChecker.Companion.isCancelled
import com.axiom.rv2ide.lsp.models.CodeFormatResult
import com.axiom.rv2ide.lsp.models.CompletionParams
import com.axiom.rv2ide.lsp.models.CompletionResult
import com.axiom.rv2ide.lsp.models.DefinitionParams
import com.axiom.rv2ide.lsp.models.DefinitionResult
import com.axiom.rv2ide.lsp.models.DiagnosticResult
import com.axiom.rv2ide.lsp.models.ExpandSelectionParams
import com.axiom.rv2ide.lsp.models.FailureType
import com.axiom.rv2ide.lsp.models.FormatCodeParams
import com.axiom.rv2ide.lsp.models.LSPFailure
import com.axiom.rv2ide.lsp.models.ReferenceParams
import com.axiom.rv2ide.lsp.models.ReferenceResult
import com.axiom.rv2ide.lsp.models.SignatureHelp
import com.axiom.rv2ide.lsp.models.SignatureHelpParams
import com.axiom.rv2ide.lsp.util.LSPEditorActions
import com.axiom.rv2ide.models.Range
import com.axiom.rv2ide.projects.FileManager.getActiveDocumentCount
import com.axiom.rv2ide.projects.IProjectManager.Companion.getInstance
import com.axiom.rv2ide.projects.IWorkspace
import com.axiom.rv2ide.projects.ModuleProject
import com.axiom.rv2ide.utils.DocumentUtils
import com.axiom.rv2ide.utils.VMUtils
...
class JavaLanguageServer : ILanguageServer {
  ...
  override suspend fun hover(params: DefinitionParams): com.axiom.rv2ide.lsp.models.MarkupContent {
    // Java LSP does not currently implement hover; return empty
    return com.axiom.rv2ide.lsp.models.MarkupContent()
  }
