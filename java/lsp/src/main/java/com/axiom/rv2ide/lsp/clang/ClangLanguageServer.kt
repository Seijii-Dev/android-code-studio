...
*/
package com.axiom.rv2ide.lsp.clang
...
class ClangLanguageServer(private val context: Context) : ILanguageServer {
  ...
  fun onContentChange(event: com.axiom.rv2ide.eventbus.events.editor.DocumentChangeEvent) {
  ...
  @org.greenrobot.eventbus.Subscribe(threadMode = org.greenrobot.eventbus.ThreadMode.ASYNC)
  fun onFileOpened(event: com.axiom.rv2ide.eventbus.events.editor.DocumentOpenEvent) {
  ...
  @org.greenrobot.eventbus.Subscribe(threadMode = org.greenrobot.eventbus.ThreadMode.ASYNC)
  fun onFileSelected(event: com.axiom.rv2ide.eventbus.events.editor.DocumentSelectedEvent) {
