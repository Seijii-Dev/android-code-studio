 ...
 */
package com.axiom.rv2ide.lsp.java.actions.generators

import android.content.Context
import com.blankj.utilcode.util.ThreadUtils
import com.axiom.rv2ide.actions.ActionData
import com.axiom.rv2ide.actions.hasRequiredData
import com.axiom.rv2ide.actions.markInvisible
import com.axiom.rv2ide.actions.newDialogBuilder
import com.axiom.rv2ide.actions.requireFile
import com.axiom.rv2ide.actions.requirePath
import com.axiom.rv2ide.lsp.java.JavaCompilerProvider
import com.axiom.rv2ide.lsp.java.actions.BaseJavaCodeAction
import com.axiom.rv2ide.lsp.java.compiler.CompileTask
import com.axiom.rv2ide.lsp.java.compiler.CompilerProvider
import com.axiom.rv2ide.lsp.java.parser.ParseTask
import com.axiom.rv2ide.lsp.java.rewrite.AddImport
import com.axiom.rv2ide.lsp.java.utils.EditHelper
import com.axiom.rv2ide.lsp.java.utils.FindHelper
import com.axiom.rv2ide.lsp.java.utils.JavaParserUtils
import com.axiom.rv2ide.lsp.java.utils.MethodPtr
import com.axiom.rv2ide.lsp.java.visitors.FindTypeDeclarationAt
...
class OverrideSuperclassMethodsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (
        !visible ||
            !data.hasRequiredData(com.axiom.rv2ide.models.Range::class.java, CodeEditor::class.java)
    ) {
      markInvisible()
      return
    }
  ...
  override suspend fun execAction(data: ActionData): Any {
    val range = data[com.axiom.rv2ide.models.Range::class.java]!!
    val compiler =
