...
package com.axiom.rv2ide.javac.services.partial

import com.axiom.rv2ide.javac.services.compiler.JavacFlowListener
import com.axiom.rv2ide.javac.services.util.ReparserUtils
import com.axiom.rv2ide.javac.services.visitors.FindAnonymousVisitor
import com.axiom.rv2ide.javac.services.visitors.TranslateMethodPositionsVisitor
...
class PartialReparserImpl : PartialReparser {
  ...
  override fun reparseMethod(
    ...
    try {
      val l = com.axiom.rv2ide.javac.services.NBLog.instance(context)
  ...
  private fun newParser(
    ...
    val factory =
        com.axiom.rv2ide.javac.services.NBParserFactory.instance(context)
            as com.axiom.rv2ide.javac.services.NBParserFactory
    val scannerFactory = ScannerFactory.instance(context)
    val cancelService = com.axiom.rv2ide.javac.services.CancelService.instance(context)
    val lexer = scannerFactory.newScanner(buf, true)
    if (
        endPositions is com.axiom.rv2ide.javac.services.NBParserFactory.NBJavacParser.EndPosTableImpl
    ) {
      endPositions.resetErrorEndPos()
    }

    return object :
        com.axiom.rv2ide.javac.services.NBParserFactory.NBJavacParser(
            factory,
            lexer,
            true,
            false,
