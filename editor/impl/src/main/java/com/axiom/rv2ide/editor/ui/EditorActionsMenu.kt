...
import com.axiom.rv2ide.editor.R.layout
import com.axiom.rv2ide.editor.databinding.LayoutPopupMenuItemBinding
import com.axiom.rv2ide.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.axiom.rv2ide.models.Range::class.java, editor.cursorLSPRange)
    data.put(
