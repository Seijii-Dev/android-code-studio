...
import com.axiom.rv2ide.lsp.util.DocumentationReferenceProvider
import com.axiom.rv2ide.progress.ProgressManager
import com.axiom.rv2ide.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
            (items[position] as? com.axiom.rv2ide.lsp.models.CompletionItem)?.data
