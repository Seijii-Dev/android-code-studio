...
package com.axiom.rv2ide.inflater.vectormaster.models;
...
import com.axiom.rv2ide.inflater.vectormaster.DefaultValues;
import com.axiom.rv2ide.inflater.vectormaster.utilities.Utils;
import com.axiom.rv2ide.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.axiom.rv2ide.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
