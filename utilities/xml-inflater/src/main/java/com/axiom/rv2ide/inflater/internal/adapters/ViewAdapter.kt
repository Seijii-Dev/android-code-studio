...
package com.axiom.rv2ide.inflater.internal.adapters
...
import com.axiom.rv2ide.annotations.inflater.ViewAdapter
import com.axiom.rv2ide.annotations.uidesigner.IncludeInDesigner
import com.axiom.rv2ide.annotations.uidesigner.IncludeInDesigner.Group.WIDGETS
import com.axiom.rv2ide.inflater.AttributeHandlerScope
...
import com.axiom.rv2ide.inflater.IViewAdapter
import com.axiom.rv2ide.inflater.internal.IncludeView
import com.axiom.rv2ide.inflater.models.UiWidget
import com.axiom.rv2ide.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return com.axiom.rv2ide.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return com.axiom.rv2ide.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return com.axiom.rv2ide.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return com.axiom.rv2ide.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return com.axiom.rv2ide.inflater.internal.utils.parsePorterDuffMode(mode)
  }
