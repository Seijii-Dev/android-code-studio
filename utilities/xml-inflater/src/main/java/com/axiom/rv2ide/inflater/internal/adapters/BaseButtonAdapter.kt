...
abstract class BaseButtonAdapter<T : Button> : IViewAdapter<T>() {
  ...
  override fun isRequiredAttribute(attribute: com.axiom.rv2ide.inflater.IAttribute): Boolean {
    if (attribute.namespace?.uri != com.axiom.rv2ide.inflater.INamespace.ANDROID.uri) {
      return false
    }
