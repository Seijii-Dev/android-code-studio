...
package com.axiom.rv2ide.inflater.internal
...
import com.axiom.rv2ide.inflater.DefaultComponentFactory
import com.axiom.rv2ide.inflater.IAttribute
import com.axiom.rv2ide.inflater.IComponentFactory
import com.axiom.rv2ide.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import com.axiom.rv2ide.inflater.ILayoutInflater
import com.axiom.rv2ide.inflater.INamespace
import com.axiom.rv2ide.inflater.IView
import com.axiom.rv2ide.inflater.IViewGroup
import com.axiom.rv2ide.inflater.InflateException
import com.axiom.rv2ide.inflater.events.IInflateEventsListener
import com.axiom.rv2ide.inflater.events.InflationFinishEvent
import com.axiom.rv2ide.inflater.events.InflationStartEvent
import com.axiom.rv2ide.inflater.events.OnApplyAttributeEvent
import com.axiom.rv2ide.inflater.events.OnInflateViewEvent
import com.axiom.rv2ide.inflater.internal.utils.IDTable
import com.axiom.rv2ide.inflater.internal.utils.ViewFactory.createViewInstance
import com.axiom.rv2ide.inflater.internal.utils.ViewFactory.generateLayoutParams
import com.axiom.rv2ide.inflater.internal.utils.parseLayoutReference
import com.axiom.rv2ide.inflater.utils.endParse
import com.axiom.rv2ide.inflater.utils.isParsing
import com.axiom.rv2ide.inflater.utils.startParse
import com.axiom.rv2ide.inflater.viewAdapter
import com.axiom.rv2ide.lookup.Lookup
import com.axiom.rv2ide.projects.android.AndroidModule
import com.axiom.rv2ide.xml.widgets.Widget
import com.axiom.rv2ide.xml.widgets.WidgetTable
import com.axiom.rv2ide.xml.widgets.WidgetType
import java.io.File
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return com.axiom.rv2ide.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = com.axiom.rv2ide.inflater.utils.module
      } else {
