...
interface ILayoutInflater : Closeable {
   ...
   *
   * **NOTE** : The [startParse][com.axiom.rv2ide.inflater.utils.startParse] method is called if it
   * hasn't been called yet. However, the [endParse] [com.axiom.rv2ide.inflater.utils.endParse] method
   ...
   * [com.axiom.rv2ide.inflater.utils.endParse].
   *
