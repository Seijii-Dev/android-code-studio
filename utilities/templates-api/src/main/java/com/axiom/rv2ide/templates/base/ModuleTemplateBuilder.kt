...
import com.axiom.rv2ide.templates.ModuleTemplateRecipeResult
import com.axiom.rv2ide.templates.RecipeExecutor
import com.axiom.rv2ide.templates.SrcSet
import com.axiom.rv2ide.templates.TemplateBuilder
import com.axiom.rv2ide.templates.TemplateRecipeConfigurator
import com.axiom.rv2ide.templates.TemplateRecipeFinalizer
import com.axiom.rv2ide.templates.base.models.Dependency
import com.axiom.rv2ide.templates.base.models.defaultDependency
import com.axiom.rv2ide.templates.base.util.SourceWriter
import java.io.File
...
abstract class ModuleTemplateBuilder :
   ...
   * @see com.axiom.rv2ide.templates.base.baseAsset
   */
  open fun baseAsset(path: String) = com.axiom.rv2ide.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.axiom.rv2ide.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
