...
package com.axiom.rv2ide.templates.base.root
...
internal fun ProjectTemplateBuilder.gradleWrapperPropsSrc(): String {
  return """
    ...
    distributionUrl=https\://services.gradle.org/distributions/gradle-${com.axiom.rv2ide.templates.GRADLE_WRAPPER_DISTRIBUTION_VERSION}-bin.zip
