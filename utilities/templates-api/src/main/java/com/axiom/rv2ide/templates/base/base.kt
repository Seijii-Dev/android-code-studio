...
package com.axiom.rv2ide.templates.base

import android.content.Context
import android.view.View
import com.axiom.rv2ide.templates.BooleanParameter
import com.axiom.rv2ide.templates.CheckBoxWidget
import com.axiom.rv2ide.templates.EnumParameter
import com.axiom.rv2ide.templates.FileTemplate
import com.axiom.rv2ide.templates.FileTemplateRecipeResult
import com.axiom.rv2ide.templates.Language
import com.axiom.rv2ide.templates.ModuleTemplate
import com.axiom.rv2ide.templates.ModuleTemplateData
import com.axiom.rv2ide.templates.ModuleType
import com.axiom.rv2ide.templates.ModuleType.AndroidApp
import com.axiom.rv2ide.templates.ModuleType.AndroidLibrary
import com.axiom.rv2ide.templates.NdkVersion
import com.axiom.rv2ide.templates.ParameterConstraint.DIRECTORY
import com.axiom.rv2ide.templates.ParameterConstraint.EXISTS
import com.axiom.rv2ide.templates.ParameterConstraint.MODULE_NAME
import com.axiom.rv2ide.templates.ParameterConstraint.NONEMPTY
import com.axiom.rv2ide.templates.ProjectTemplate
import com.axiom.rv2ide.templates.ProjectTemplateData
import com.axiom.rv2ide.templates.ProjectVersionData
import com.axiom.rv2ide.templates.R
import com.axiom.rv2ide.templates.Sdk
import com.axiom.rv2ide.templates.SpinnerWidget
import com.axiom.rv2ide.templates.StringParameter
import com.axiom.rv2ide.templates.TextFieldWidget
import com.axiom.rv2ide.templates.base.util.getNewProjectName
import com.axiom.rv2ide.templates.base.util.moduleNameToDir
import com.axiom.rv2ide.templates.enumParameter
import com.axiom.rv2ide.templates.minSdkParameter
import com.axiom.rv2ide.templates.packageNameParameter
import com.axiom.rv2ide.templates.projectLanguageParameter
import com.axiom.rv2ide.templates.projectNameParameter
import com.axiom.rv2ide.templates.projectNdkVersionParameter
import com.axiom.rv2ide.templates.stringParameter
import com.axiom.rv2ide.templates.useKtsParameter
import com.axiom.rv2ide.templates.useNdkParameter
import com.axiom.rv2ide.utils.AndroidUtils
...
internal fun saveLastSaveLocation(context: Context?, location: String) {
  ...
  try {
    ...
    // Save back to file
    acsideFile.outputStream().use { props.store(it, "Axiom ACS Configuration") }
  } catch (e: Exception) {
    e.printStackTrace()
  }
}
