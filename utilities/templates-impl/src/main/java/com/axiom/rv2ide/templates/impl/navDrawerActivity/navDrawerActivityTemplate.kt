...
package com.axiom.rv2ide.templates.impl.navDrawerActivity

import com.axiom.rv2ide.templates.Language.Kotlin
...
import com.axiom.rv2ide.templates.base.util.AndroidModuleResManager.ResourceType.NAVIGATION
...
import com.axiom.rv2ide.templates.impl.templateAsset
  ...
  defaultAppModule {
    recipe = createRecipe {
      ...
      res {
        ...
        putStringRes("nav_header_title", "Axiom ACS")
