...
package com.axiom.rv2ide.uidesigner.adapters
...
import com.axiom.rv2ide.inflater.IView.SingleAttributeChangeListener
import com.axiom.rv2ide.uidesigner.R
import com.axiom.rv2ide.uidesigner.adapters.ViewAttrListAdapter.VH
import com.axiom.rv2ide.uidesigner.databinding.LayoutViewattrItemBinding
import com.axiom.rv2ide.uidesigner.models.UiAttribute
...
internal class ViewAttrListAdapter(
    attributes: List<com.axiom.rv2ide.inflater.IAttribute>,
    private val viewModel: WorkspaceViewModel?,
    private val onDeleteAttr: (com.axiom.rv2ide.inflater.IAttribute) -> Boolean,
    private val onClick: (com.axiom.rv2ide.inflater.IAttribute) -> Unit,
      ...
      val attrUpdateListener =
          object : SingleAttributeChangeListener() {
            override fun onAttributeUpdated(
                ...
                attribute: com.axiom.rv2ide.inflater.IAttribute,
                oldValue: String,
            ) {
