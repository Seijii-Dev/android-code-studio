...
import com.axiom.rv2ide.inflater.viewGroup
import com.axiom.rv2ide.uidesigner.R
import com.axiom.rv2ide.uidesigner.models.PlaceholderView
import com.axiom.rv2ide.uidesigner.undo.ViewAddedAction
import com.axiom.rv2ide.uidesigner.undo.ViewMovedAction
import com.axiom.rv2ide.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler : IViewGroup.SingleOnHierarchyChangeListener() {
  ...
  private fun pushAction(
      view: com.axiom.rv2ide.inflater.IView,
      parent: IViewGroup,
      index: Int,
      added: Boolean,
  ) {
  ...
  override fun beforeViewAdded(group: IViewGroup, view: com.axiom.rv2ide.inflater.IView, index: Int) {
    animateLayoutChange()
  }
  ...
  override fun onViewAdded(group: IViewGroup, view: com.axiom.rv2ide.inflater.IView, index: Int) {
    val frag = this.fragment ?: return
  ...
  override fun onViewRemoved(group: IViewGroup, view: com.axiom.rv2ide.inflater.IView, index: Int) {
    val frag = this.fragment ?: return
