...
package com.axiom.rv2ide.uidesigner.utils
...
import com.axiom.rv2ide.inflater.internal.LayoutInflaterImpl
...
class UiLayoutInflater : LayoutInflaterImpl() {
  ...
  private fun createMaterialDesignComponent(
    ...
    inflationEventListener?.onEvent(com.axiom.rv2ide.inflater.events.OnInflateViewEvent(view))
