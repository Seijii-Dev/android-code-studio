...
package com.axiom.rv2ide.uidesigner.fragments

// import com.axiom.rv2ide.uidesigner.utils.applyBackgroundPreview
...
import com.axiom.rv2ide.fragments.BaseFragment
import com.axiom.rv2ide.inflater.IView
import com.axiom.rv2ide.inflater.internal.AttributeImpl
import com.axiom.rv2ide.inflater.internal.LayoutFile
import com.axiom.rv2ide.inflater.internal.ViewGroupImpl
import com.axiom.rv2ide.inflater.internal.ViewImpl
import com.axiom.rv2ide.inflater.utils.endParse
import com.axiom.rv2ide.inflater.utils.startParse
import com.axiom.rv2ide.uidesigner.R
import com.axiom.rv2ide.uidesigner.UIDesignerActivity
import com.axiom.rv2ide.uidesigner.databinding.FragmentDesignerWorkspaceBinding
import com.axiom.rv2ide.uidesigner.drag.WidgetDragListener
import com.axiom.rv2ide.uidesigner.drag.WidgetTouchListener
import com.axiom.rv2ide.uidesigner.drawable.UiViewLayeredForeground
import com.axiom.rv2ide.uidesigner.models.CommonUiView
import com.axiom.rv2ide.uidesigner.models.PlaceholderView
import com.axiom.rv2ide.uidesigner.models.RootWorkspaceView
import com.axiom.rv2ide.uidesigner.models.UiViewGroup
import com.axiom.rv2ide.uidesigner.undo.UndoManager
import com.axiom.rv2ide.uidesigner.utils.UiLayoutInflater
import com.axiom.rv2ide.uidesigner.utils.applyPreview
import com.axiom.rv2ide.uidesigner.utils.bgDesignerView
import com.axiom.rv2ide.uidesigner.utils.layeredForeground
import com.axiom.rv2ide.uidesigner.viewmodel.M3ComponentState
import com.axiom.rv2ide.uidesigner.viewmodel.WorkspaceViewModel
import java.io.File
...
class DesignerWorkspaceFragment : BaseFragment() {
  ...
  private fun createM3ComponentFromState(m3Component: M3ComponentState): IView? {
    return try {
      ...
      val layoutFile = com.axiom.rv2ide.inflater.internal.LayoutFile(File(""), "")
      val iView =
          when (view) {
            is MaterialButton -> {
              // Use ViewImpl instead of checking the actual view type
              com.axiom.rv2ide.inflater.internal.ViewImpl(layoutFile, m3Component.type, view)
            }
            is MaterialCardView -> {
              com.axiom.rv2ide.inflater.internal.ViewGroupImpl(layoutFile, m3Component.type, view)
            }
            is MaterialTextView -> {
              com.axiom.rv2ide.inflater.internal.ViewImpl(layoutFile, m3Component.type, view)
            }
        ...
        try {
          val namespace =
              if (attrName.startsWith("app:")) {
                com.axiom.rv2ide.inflater.INamespace.APP
              } else {
                com.axiom.rv2ide.inflater.INamespace.ANDROID
              }
          val attr =
              com.axiom.rv2ide.inflater.internal.AttributeImpl(
                  namespace = namespace,
