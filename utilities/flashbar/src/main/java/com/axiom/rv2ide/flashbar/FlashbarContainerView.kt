package com.axiom.rv2ide.flashbar
...
import com.axiom.rv2ide.flashbar.Flashbar.Companion.DURATION_INDEFINITE
import com.axiom.rv2ide.flashbar.Flashbar.DismissEvent
import com.axiom.rv2ide.flashbar.Flashbar.DismissEvent.*
import com.axiom.rv2ide.flashbar.Flashbar.Gravity.BOTTOM
import com.axiom.rv2ide.flashbar.Flashbar.Gravity.TOP
import com.axiom.rv2ide.flashbar.Flashbar.OnBarDismissListener
import com.axiom.rv2ide.flashbar.Flashbar.OnBarShowListener
import com.axiom.rv2ide.flashbar.Flashbar.OnTapListener
import com.axiom.rv2ide.flashbar.Flashbar.Vibration
import com.axiom.rv2ide.flashbar.Flashbar.Vibration.DISMISS
import com.axiom.rv2ide.flashbar.Flashbar.Vibration.SHOW
import com.axiom.rv2ide.flashbar.SwipeDismissTouchListener.DismissCallbacks
import com.axiom.rv2ide.flashbar.anim.FlashAnim
import com.axiom.rv2ide.flashbar.anim.FlashAnimBarBuilder
import com.axiom.rv2ide.flashbar.anim.FlashAnimIconBuilder
import com.axiom.rv2ide.flashbar.util.NavigationBarPosition.*
import com.axiom.rv2ide.flashbar.util.afterMeasured
import com.axiom.rv2ide.flashbar.util.getNavigationBarPosition
import com.axiom.rv2ide.flashbar.util.getNavigationBarSizeInPx
import com.axiom.rv2ide.flashbar.util.getRootView
...
internal class FlashbarContainerView(context: Context) : RelativeLayout(context), DismissCallbacks {
  ...
  internal fun adjustOrientation(activity: Activity) {
    ...
    when (navigationBarPosition) {
      ...
      com.axiom.rv2ide.flashbar.util.NavigationBarPosition.TOP ->
          flashbarContainerViewLp.topMargin = navigationBarSize
      RIGHT -> flashbarContainerViewLp.rightMargin = navigationBarSize
      com.axiom.rv2ide.flashbar.util.NavigationBarPosition.BOTTOM ->
